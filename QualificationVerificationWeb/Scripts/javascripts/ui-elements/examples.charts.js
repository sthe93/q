	...
	(function() {
		var target = $('#gaugeBasic'),
			opts = $.extend(true, {}, {
				...
				colorStart: '#E7540E', // Colors
				colorStop: '#E7540E', // just experiment with them
