<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Completed.aspx.cs" Inherits="QualificationVerificationWeb.Admin.Completed" MasterPageFile="~/Admin/AcademicDocumentMaster.Master" Async="true"%>
     ...
     <div class="row">
                    <div id="tabParent" class="tabs tabs-primary">
                        <ul class="nav nav-tabs">
                            ...
                            <li id="tabApprove" runat="server"   tabindex="1">
                            ...
                            <li id="tabCompleted" runat="server"  class="active" tabindex="4">
                                <a runat="server" id="CompletedLink" href="Completed.aspx">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Identifier Number">
                                                 ...
                                                 <asp:TemplateField HeaderText="Date Completed">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDateCompleted" runat="server" Text='<%#Eval("LastUpdated") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Completed By">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCompletedBy" runat="server" Text='<%#Eval("LastUpdatedBy") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <asp:GridView ID="gvExport" runat="server" PageSize="2" Width="700px" AutoGenerateColumns="False">
                                         <Columns>
                                            ...
                                            <asp:BoundField Visible="true" DataField="PaymentStatus" HeaderText="Transaction Status" SortExpression="PaymentStatus" />
                                             ...
                                             <asp:BoundField Visible="true" DataField="LastUpdatedBy" HeaderText="Completed By" SortExpression="LastUpdatedBy" />
                                             <asp:BoundField Visible="true" DataField="LastUpdated" HeaderText="Date Completed" SortExpression="LastUpdated" />
                                         </Columns>
                                    </asp:GridView>
                                </div>
                                    <br />
