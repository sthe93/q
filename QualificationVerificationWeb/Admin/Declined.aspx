<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Declined.aspx.cs" Inherits="QualificationVerificationWeb.Admin.Declined" MasterPageFile="~/Admin/AcademicDocumentMaster.Master" Async="true"%>
    ...
    <div class="row">
        <div id="tabParent" class="tabs tabs-primary">
            <ul class="nav nav-tabs">
                ...
                <li id="tabDeclined" runat="server" tabindex="2" class="active">
                    <a runat="server" id="DeclinedLink" href="Declined.aspx">
                                        ...
                                        <div style="overflow: auto; overflow-style: panner">
                                            <asp:GridView ID="gvAllOrders" runat="server" AllowPaging="true" PagerSettings-Mode="Numeric" PagerSettings-PageButtonCount="4" Class="table table-bordered table-striped mb-none" PageSize="15" AutoGenerateColumns="False" HeaderStyle-CssClass="control-label" OnPageIndexChanging="gvAllOrders_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Date Declined">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDateDeclined" runat="server" Text='<%#Eval("LastUpdated") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Declined By">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDeclinedBy" runat="server" Text='<%#Eval("LastUpdatedBy") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Actions">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="view" runat="server" CommandArgument='<%# Eval("StudentID")%>' CommandName="viewARequest" OnClick="view_Click">View Request</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <asp:GridView ID="gvExport" runat="server" PageSize="2" Width="700px" AutoGenerateColumns="False">
                                                <Columns>
                                                   ...
                                                   <%-- <asp:BoundField Visible="true" DataField="ReferenceNumber" HeaderText="Reference Number" SortExpression="ReferenceNumber" />--%>
                                                    ...
                                                    <asp:BoundField Visible="true" DataField="LastUpdatedBy" HeaderText="Declined By" SortExpression="LastUpdatedBy" />
                                                    <asp:BoundField Visible="true" DataField="LastUpdated" HeaderText="Date Declined" SortExpression="LastUpdated" />
                                                </Columns>
                                            </asp:GridView>
                                        </div>
                                        <br />
